...
class PrivacySettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<PrivacySettingViewModel>.reactive(
      onModelReady: (model) => model.fetch_initial_data(),
      ...
      builder: (context, model, child) => Scaffold(
          ...
          body: model.loadingContents == true
              ? Center(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        PrivacySettingsTile(
                          ...
                          onTap: () {
                            model
                                .whoCanSeeContents('Who can see your contents');
                          },
                        ...
                        PrivacySettingsTile(
                          ...
                          onTap: () {
                            model.whoCanSeeChallenges(
                                'Who can see your challenges?');
                          },
                        ...
                        PrivacySettingsTile(
                          ...
                          onTap: () {
                            model
                                .whoCanSeeChoices('Who can see your choices?2');
                          },
